...
$$\rho^Z(r, \theta, \varphi) = \sum_i^{|Z|} e^{- \frac{1}{2\sigma^2} \vert r - R_i \vert^2 }$$ %TODO: Should r be bold(r)?
%TODO: What is R_i??

The summation $i$ runs over all the atmos of that species. $R_i$ is the center of that atom. %TODO: Is it?
